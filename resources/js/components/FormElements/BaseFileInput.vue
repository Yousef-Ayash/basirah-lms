...
const handleFileChange = (e) => {
    ...
    // emit the file object or null when nothing selected
    emit('update:modelValue', file);
};

// optional helper to clear input programmatically (not used here, but useful)
function clear() {
    if (fileInput.value) {
