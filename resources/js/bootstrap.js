...
axios.defaults.withCredentials = true; // <-- ensure cookies are sent for XHR
...
if (tokenMeta) {
    ...
    console.warn(
        'CSRF token not found (meta[name="csrf-token"]). If you see 419 errors, add the token to your layout.',
    );
}
